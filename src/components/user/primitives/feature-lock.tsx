    ...
    <div className="max-w-md mx-auto px-4 py-10">
      <div className="rounded-2xl border border-(--app-line) bg-(--app-surface) p-6 text-center">
        ...
        <div className="mt-4 flex flex-col sm:flex-row items-center justify-center gap-2">
          ...
          <Link
            href="/packages"
            className="inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-lg bg-(--app-surface-2) hover:bg-(--app-surface-2) text-white text-sm font-semibold active:scale-[0.97] transition-transform"
          >
            View plans
