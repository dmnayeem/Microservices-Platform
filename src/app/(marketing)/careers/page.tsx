    ...
    <>
        ...
        <div className="space-y-3">
          {ROLES.map((r) => (
            <a
              ...
              className="group block rounded-2xl bg-white border border-slate-200 backdrop-blur-xl p-5 hover:bg-slate-100 hover:border-blue-500/30 transition-all"
            >
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2 text-xs text-slate-600">
                    <span className="rounded-full bg-white border border-slate-200 px-2.5 py-1">{r.team}</span>
                    <span className="inline-flex items-center gap-1 rounded-full bg-white border border-slate-200 px-2.5 py-1"><MapPin className="h-3 w-3" /> {r.location}</span>
                    <span className="rounded-full bg-white border border-slate-200 px-2.5 py-1">{r.type}</span>
                  </div>
                </div>
      ...
      <Section>
        <GlassCard className="text-center sm:p-12">
          <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900">Ready to apply?</h2>
