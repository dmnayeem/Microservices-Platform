    ...
    <>
      ...
      <Section>
        ...
        <Link
          ...
          className="group block rounded-3xl bg-white border border-slate-200 backdrop-blur-xl overflow-hidden hover:border-blue-500/30 transition-all"
        >
          <div className="grid md:grid-cols-2">
            ...
            <div className="p-6 sm:p-10">
              ...
              <h2 className="mt-4 text-2xl sm:text-3xl font-extrabold text-slate-900">{featured.title}</h2>
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {rest.map((p) => (
            <Link
              key={p.slug}
              href={`/blog/${p.slug}`}
              className="group flex flex-col rounded-2xl bg-white border border-slate-200 backdrop-blur-xl overflow-hidden hover:border-blue-500/30 transition-all"
            >
              ...
              <div className="flex flex-1 flex-col p-5">
                <div className="flex items-center gap-2 text-[11px] text-slate-600">
                  <span className="rounded-full bg-white border border-slate-200 px-2 py-0.5">{p.category}</span>
